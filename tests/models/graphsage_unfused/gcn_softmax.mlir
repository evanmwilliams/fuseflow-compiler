...
func.func @matmul1 (%arg0 : tensor<1767x121xf32>, %argout : tensor<1767x121xf32>) -> tensor<1767x121xf32> {
  ...
  %28 = linalg.generic {indexing_maps = [#map, #map2, #map], iterator_types = ["parallel", "parallel"]} ins(%22, %26 : tensor<1767x121xf32>, tensor<1767x1xf32>) outs(%13 : tensor<1767x121xf32>) {
  ^bb0(%in: f32, %in_5: f32, %out: f32):
    %29 = arith.subf %in, %in_5 : f32
    linalg.yield %29 : f32
  } -> tensor<1767x121xf32>
