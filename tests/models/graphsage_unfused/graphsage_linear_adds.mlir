...
func.func @matmul1 (%arg0 : tensor<1767x50xf32>, %arg1 : tensor<1767x50xf32>, %argout : tensor<1767x50xf32>) -> tensor<1767x50xf32> {
  %2 = linalg.add ins(%arg0, %arg1 : tensor<1767x50xf32>, tensor<1767x50xf32>) outs(%argout : tensor<1767x50xf32>) -> tensor<1767x50xf32>
