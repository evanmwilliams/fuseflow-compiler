...
// LUNA16 Unfused 5: Decoder Bias only
// Input: (32, 262144), Bias: (262144,) -> Output: (32, 262144)
module attributes {torch.debug_module_name = "LUNA16_Unfused_5_Dec_Bias"} {
  ml_program.global private mutable @global_seed(dense<0> : tensor<i64>) : tensor<i64>
  func.func @forward(%input: tensor<32x262144xf32, #SPARSE>) -> tensor<32x262144xf32, #SPARSE> {
    ...
    } ins(%input, %cst_decoder_bias : tensor<32x262144xf32, #SPARSE>, tensor<262144xf32>)
