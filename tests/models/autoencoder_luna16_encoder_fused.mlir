...
// Input: (32, 262144), Weight: (262144, 512), Bias: (512,) -> Output: (32, 512)
module attributes {torch.debug_module_name = "LUNA16_Encoder_Fused"} {
  ml_program.global private mutable @global_seed(dense<0> : tensor<i64>) : tensor<i64>
  func.func @forward(%input: tensor<32x262144xf32, #SPARSE>) -> tensor<32x512xf32, #SPARSE> {
    ...
    } ins(%input, %cst_encoder_weight : tensor<32x262144xf32, #SPARSE>, tensor<262144x512xf32, #SPARSE>)
