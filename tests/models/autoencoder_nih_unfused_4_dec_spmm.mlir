...
// NIH Unfused 4: Decoder SpMM only
// Input: (32, 512), Weight: (512, 1048576) -> Output: (32, 1048576)
module attributes {torch.debug_module_name = "NIH_Unfused_4_Dec_SpMM"} {
  ...
  func.func @forward(%input: tensor<32x512xf32, #SPARSE>) -> tensor<32x1048576xf32, #SPARSE> {
    ...
    return %dec_matmul : tensor<32x1048576xf32, #SPARSE>
  }
}
