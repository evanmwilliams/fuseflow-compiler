...
module attributes {torch.debug_module_name = "CustomGraphSAGE"} {
  ...
  func.func @forward(%arg0: tensor<1767x50xf32, #SPARSE>, %arg1: tensor<1767x1767xf32, #SPARSE>, %cst_1: tensor<16xf32, #SPARSE1D>, %9: tensor<50x16xf32, #SPARSE>, %cst_5: tensor<121xf32, #SPARSE1D>, %16: tensor<16x121xf32, #SPARSE>) -> tensor<1767x121xf32, #SPARSE> {
