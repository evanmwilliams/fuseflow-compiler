...
// Input: (32, 1048576), Weight: (1048576, 512), Bias: (512,) -> Output: (32, 512)
module attributes {torch.debug_module_name = "NIH_Encoder_Fused"} {
  ml_program.global private mutable @global_seed(dense<0> : tensor<i64>) : tensor<i64>
  func.func @forward(%input: tensor<32x1048576xf32, #SPARSE>) -> tensor<32x512xf32, #SPARSE> {
    ...
    } ins(%input, %cst_encoder_weight : tensor<32x1048576xf32, #SPARSE>, tensor<1048576x512xf32, #SPARSE>)
