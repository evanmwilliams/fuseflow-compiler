...
func.func @matmul1 (%arg0 : tensor<1767x50xf32>, %arg1 : tensor<50x16xf32, #SPARSE>, %argout : tensor<1767x16xf32>) -> tensor<1767x16xf32> {
  %2 = linalg.matmul ins(%arg0, %arg1 : tensor<1767x50xf32>, tensor<50x16xf32, #SPARSE>) outs(%argout : tensor<1767x16xf32>) -> tensor<1767x16xf32>
