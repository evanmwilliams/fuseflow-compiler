...
module attributes {torch.debug_module_name = "GCN"} {
  ...
  func.func @forward(%arg2: tensor<1767x16xf32>, %arg0: tensor<1767x50xf32>, %arg1: tensor<1767x1767xf32, #SPARSE>) -> tensor<1767x16xf32, #SPARSE> {
    ...
    %8 = linalg.generic {indexing_maps = [#map, #map2, #map], iterator_types = ["parallel", "parallel"]} ins(%arg2, %cst_3 : tensor<1767x16xf32>, tensor<16xf32, #SPARSE1D>) outs(%5 : tensor<1767x16xf32, #SPARSE>) {
