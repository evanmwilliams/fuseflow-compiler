...
module attributes {torch.debug_module_name = "GCN"} {
  ...
  func.func @forward(%arg0: tensor<1767x50xf32>, %arg1: tensor<1767x1767xf32, #SPARSE>) -> tensor<1767x16xf32> {
    ...
    %7 = linalg.matmul ins(%arg0, %4 : tensor<1767x50xf32>, tensor<50x16xf32, #SPARSE>) outs(%6 : tensor<1767x16xf32>) -> tensor<1767x16xf32>
    %8 = linalg.generic {indexing_maps = [#map, #map2, #map], iterator_types = ["parallel", "parallel"]} ins(%7, %cst_3 : tensor<1767x16xf32>, tensor<16xf32, #SPARSE1D>) outs(%5 : tensor<1767x16xf32>) {
    ...
    %15 = linalg.matmul ins(%10, %12 : tensor<1767x16xf32>, tensor<16x121xf32>) outs(%14 : tensor<1767x121xf32, #SPARSE>) -> tensor<1767x121xf32, #SPARSE>
