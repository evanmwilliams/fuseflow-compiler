...
module attributes {torch.debug_module_name = "GCN"} {
  ...
  func.func @forward(%arg0: tensor<1767x50xf32>, %arg1: tensor<1767x1767xf32, #SPARSE>) -> tensor<1767x121xf32, #SPARSE> {
    ...
    %15 = linalg.matmul ins(%10, %12 : tensor<1767x16xf32>, tensor<16x121xf32, #SPARSE>) outs(%14 : tensor<1767x121xf32, #SPARSE>) -> tensor<1767x121xf32, #SPARSE>
