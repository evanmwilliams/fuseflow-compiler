...
module attributes {torch.debug_module_name = "GCN"} {
  ...
  func.func @forward(%arg2: tensor<1767x121xf32>, %arg0: tensor<1767x50xf32>, %arg1: tensor<1767x1767xf32, #SPARSE>) -> tensor<1767x121xf32, #SPARSE> {
    ...
    %16 = linalg.generic {indexing_maps = [#map, #map2, #map], iterator_types = ["parallel", "parallel"]} ins(%arg2, %cst_4 : tensor<1767x121xf32>, tensor<121xf32, #SPARSE1D>) outs(%13 : tensor<1767x121xf32, #SPARSE>) {
    ^bb0(%in: f32, %in_5: f32, %out: f32):
      %29 = arith.addf %in, %in_5 : f32
      linalg.yield %29 : f32
