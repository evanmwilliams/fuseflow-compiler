...
module attributes {torch.debug_module_name = "GCN"} {
  ...
  func.func @forward(%arg2: tensor<1767x16xf32>, %arg0: tensor<1767x50xf32>, %arg1: tensor<1767x1767xf32, #SPARSE>) -> tensor<1767x121xf32, #SPARSE> {
    ...
    %75 = tensor.empty() : tensor<1767x16xf32>
    %6 = linalg.fill ins(%cst_0 : f32) outs(%5 : tensor<1767x16xf32, #SPARSE>) -> tensor<1767x16xf32, #SPARSE>
    %7 = linalg.matmul ins(%2, %4 : tensor<1767x50xf32>, tensor<50x16xf32, #SPARSE>) outs(%6 : tensor<1767x16xf32, #SPARSE>) -> tensor<1767x16xf32, #SPARSE>
    ...
    %9 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"]} ins(%arg2 : tensor<1767x16xf32>) outs(%75 : tensor<1767x16xf32>) {
    ^bb0(%in: f32, %out: f32):
      %29 = arith.cmpf ugt, %in, %cst_0 : f32
      %30 = arith.select %29, %in, %cst_0 : f32
      linalg.yield %30 : f32
    } -> tensor<1767x16xf32>
    %10 = linalg.matmul ins(%arg1, %9 : tensor<1767x1767xf32, #SPARSE>, tensor<1767x16xf32>) outs(%6 : tensor<1767x16xf32, #SPARSE>) -> tensor<1767x16xf32, #SPARSE>
