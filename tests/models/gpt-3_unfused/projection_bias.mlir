...
module {
  ...
  func.func @main(%arg0: tensor<1x1024x768xf32>) -> tensor<1x1024x768xf32> {
    ...
    %1 = linalg.generic {indexing_maps = [#map4, #map7, #map4], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg0, %cst_5 : tensor<1x1024x768xf32>, tensor<768xf32>) outs(%0 : tensor<1x1024x768xf32>) {
